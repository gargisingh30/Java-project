import edu.campus.ccrm.domain.Course;
import edu.campus.ccrm.domain.Student;
import edu.campus.ccrm.domain.Semester;
import edu.campus.ccrm.domain.enums.Semester.Season;
import edu.campus.ccrm.service.CourseService;
import edu.campus.ccrm.service.StudentService;
import edu.campus.ccrm.service.EnrollmentService;
...
public class Demo {
        public static void main(String[] args) {
                ...
                try {
                        ...
                        List<Student> searchResults = studentService.searchStudentsByName("John");
                        System.out.println("Students found with 'John' in name: " + searchResults.size());

                        List<Course> courseSearchResults = courseService.searchCoursesByName("Programming");
                        ...
                        try {
                                ...
                                List<String> backups = fileManager.listAvailableBackups();
